...
enum FLLayoutComputer {
    static func layout<Node: FLNode>(
        _ node: Node,
...
final class FLLayoutCache<Node: FLNode>: @unchecked Sendable {
    ...
    func layout(for node: Node, in context: FLContext) -> Node.Layout {
